...
public:
    ...
    void testPreVisitWhenAttributeIsNotInProgramAndLocationIsSpecified() {
        ...
        // Create attribute node
        RapidGL::AttributeNode attributeNode("TexCoord0", RapidGL::AttributeNode::TEXCOORD0, 4);
    ...
    void testPreVisitWhenAttributeIsNotInProgramAndLocationIsUnspecified() {
        ...
        // Create attribute node
        RapidGL::AttributeNode attributeNode("TexCoord0", RapidGL::AttributeNode::TEXCOORD0, -1);
